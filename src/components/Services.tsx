  ...
  return (
    <section className="bg-black text-white flex flex-col items-center justify-center min-h-screen py-24 px-6 font-[Poppins]">
      ...
      <div className="flex flex-wrap justify-center gap-8 max-w-6xl">
        {/* Card 1 */}
        <div className="relative bg-gradient-to-b from-[#5CC6D0] to-[#0097A1] text-white rounded-[20px] w-[341px] h-[412px] p-8 flex flex-col justify-between cursor-pointer transition-all duration-300 hover:-translate-y-2">
          <div>
            <h3 className="font-[Poppins] font-semibold text-[24px] leading-[100%] mb-4">
              Asset
              <br></br>Management
            </h3>
            <p className="font-[Poppins] font-normal text-[16px] leading-[100%]">
              Streamlined solutions with <strong>400,000+</strong> parts for
              seamless fleet operations.
            </p>
          </div>
          <div className="flex justify-end">
            <div className="w-10 h-10 flex items-center justify-center bg-white/20 rounded-full transition-transform duration-300 hover:translate-x-1">
        ...
        {/* Card 2 */}
        <div className="group relative bg-gray-200 text-black rounded-[20px] w-[341px] h-[412px] p-8 flex flex-col justify-between cursor-pointer transition-all duration-300 hover:-translate-y-2 hover:text-white overflow-hidden">
